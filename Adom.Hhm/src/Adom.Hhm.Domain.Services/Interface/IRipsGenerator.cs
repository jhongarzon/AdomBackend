...
namespace Adom.Hhm.Domain.Services.Interface
{
    public interface IRipsGenerator
    {
        ...
        string GenerateApFile(string basePath, RipsFilter ripsFilter, IEnumerable<Rips> rips);
        string GenerateAcFile(string basePath, RipsFilter ripsFilter, IEnumerable<Rips> rips);
        string GenerateAtFile(string basePath, RipsFilter ripsFilter, IEnumerable<Rips> rips);
